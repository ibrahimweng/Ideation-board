...
const SUITES = [
  ...
  'help', 'findall', 'sendable', 'finish', 'plate', 'dialogs', 'framing', 'layer', 'vary', 'pair', 'undoboards', 'undelete', 'nospace', 'draw', 'mcp', 'moving', 'embed', 'offline', 'reclaim', 'manyboards', 'stacked', 'big', 'pdf', 'audio', 'design',
