...
export function EffectsPanel({ tab, onTab, say }: Props) {
  ...
  /* Words, which are their own thing for the same reason: nothing above this
     applies to a note or a label — there is no shader, no tone and no crop —
     and the questions that do apply to them are asked nowhere else. */
