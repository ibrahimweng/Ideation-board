...
export function buildCommands(a: CommandActions): Command[] {
  ...
  return [
    ...
    cmd('view.present', a.selection.length > 1 ? `Present the ${a.selection.length} selected` : 'Present this board', 'View', () => a.setPresenting(true), { hint: KEYS.present.hint, keywords: 'slideshow full screen show demo' }),
