    ...
    },
    {
      ...
      body: (
        <>
          ...
          <p>
            Sounds go in it too, and what goes in is the treated one: the page plays what the card
            plays, waveform and all. They are carried at a size made for listening rather than for
